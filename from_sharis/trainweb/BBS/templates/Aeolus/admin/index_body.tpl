...
<h1>Aeolus phpBB Style Notes</h1>
<p>
...
<br />
For support visit: <a href="http://www.trushkin.net/support.php?style=aeolus&amp;url={TPL_FORUM_URL}" target="_blank">http://www.trushkin.net/support.php</a><br />
To check for updates and extras click here: <a href="http://www.trushkin.net/phpbb.php?style=aeolus&amp;version={C_VERSION}&amp;url={TPL_FORUM_URL}" target="_blank">http://www.trushkin.net/phpbb.php?style=aeolus</a><br />
If you have any questions contact me: <a href="http://www.trushkin.net/contact.php?style=aeolus&amp;url={TPL_FORUM_URL}" target="_blank">http://www.trushkin.net/contact.php</a><br />
<br />
Sincerely,<br />
Vjacheslav Trushkin.
</p>
