...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<tr>
		...
		<td class="{user_row.ROW_CLASS}"><span class="gen" {user_row.STYLE_COLOR}><b><a href="{user_row.U_PROFILE}" class="gen" target="_self" {user_row.STYLE_COLOR}>{user_row.USERNAME}</a></b></span></td>
