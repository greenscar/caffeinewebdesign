...
<!-- BEGIN catrow -->
{TPL_HDR1}<span class="cattitle">&nbsp;<a href="{catrow.U_VIEWCAT}" class="cattitle">{catrow.CAT_DESC}</a>&nbsp;</span>{TPL_HDR2}<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
<tr> 
