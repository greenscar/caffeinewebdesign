...
<tr>
	...
	<tr height="26">
		<td align="left" valign="middle" nowrap="nowrap"><span class="th"><img src="{T_TEMPLATE_PATH}/images/icon_minipost.gif" alt="{L_POST}" /><span class="genmed">{L_POSTED}: {POST_DATE}</span></span></td>
	</tr></table></td>
</tr>
<tr>
