<?php
require("./inc_files/A_Person.inc");
include("./inc_files/sql_connect.inc");
session_start();
if((@$_POST["Submit"]) || (session_is_registered("store_admin"))){
	if(session_is_registered("store_admin")){
      //LOGIN IS SUCCESSFUL
      //echo("login was good.");
      $store_admin = $_SESSION['store_admin'];
      //Header("Location: index.htm");
		...
		if (($search_occurances != '0')) { 
			...
			session_register("store_admin");
			$store_admin = new A_Person($row["login"]);
