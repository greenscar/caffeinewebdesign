...
function connect_to_mssql($host_name, $user_name, $password, $database, $port=1433){
    $dbcnx = MSSQL_CONNECT("$host_name,$port" ,$user_name,$password) or DIE("<h1>DATABASE FAILED TO RESPOND.</h1>"); 
...
function display_mssql_db($host_name, $user_name, $password, $database, $port=1433){
    if(!(connect_to_mssql($host_name, $user_name, $password, $database, $port)))
    {
