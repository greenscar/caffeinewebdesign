...
<FONT SIZE="+1"><B> Produce Purchases</B></FONT>
<BODY BGCOLOR="#FFFFF">
<!--  Page directive. -->
...
<BR><BR>
<FORM METHOD="post" ACTION="/shopping/CustomerServlet">
...
--%>
<%
    if((BasketBean)session.getAttribute(BasketBean.BASKET) != null)
        basket = (BasketBean)session.getAttribute(BasketBean.BASKET);
    else
        basket = new BasketBean();
    //System.err.println("basket assigned from session");
